...
if __name__ == "__main__":
    ...
    system_prompt = "You are an expert Oncologist reviewing a report your resident has prepared. The patient has questions about the side effects of their cancer medications they are taking, read this report step by step and explain to the patient what they need to know about their medication regimen."
    user_prompt_template = "Report: {note_text} \nQuestion: What does the patient need to know about their medication regimen regarding side effects.\nAnswer: "
